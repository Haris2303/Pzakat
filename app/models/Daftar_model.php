...
class Daftar_model
{
  ...
  public function daftarMuzakki($data): int
  {
    ...
    $selectDataUsername   = "SELECT username FROM $tableUser WHERE username = :username";
    $selectDataEmailNohp  = "SELECT email, nohp FROM $tableMuzakki WHERE email = :email AND nohp = :nohp";
