...
class Transaksi_model {
    ...
    public function konfirmasiDataTransaksi($dataPost, $dataFile)
    {
         ...
         * 
         */
        $getIDPembayaran = "SELECT id_pembayaran FROM tb_donatur INNER JOIN tb_pembayaran ON tb_donatur.id_donatur = tb_pembayaran.id_donatur WHERE tb_donatur.id_donatur = 3";
        ...
        // // hapus cookie
        // setcookie('nominal-donasi', '', time() - 3600);
        // setcookie('id-bank', '', time() - 3600);
