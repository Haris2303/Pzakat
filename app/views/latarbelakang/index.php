<div class="container">
  <div class="content">
    ...
    <div>
      <?php echo $data['latar-belakang']['content']?>
    </div>
    ...
    <div class="text-center mt-20">
      <div class="inline-flex text-lightgray items-center mr-5">
        ...
        <span>Dibuat oleh: <strong><?= $data['latar-belakang']['username'] ?></strong></span>
      </div>
      ...
      <div class="inline-flex items-center text-lightgray">
        ...
        <span>Dibuat pada: <strong><?= date('d F Y',strtotime(explode(' ', $data['latar-belakang']['datetime'])[0])) ?></strong></span>
      </div>
    </div>
