<div class="container">
  <div class="content">
    ...
    <form action="<?= BASEURL ?>/transaksi/zakatpenghasilan" method="post" class="flex flex-wrap">
      <div class="w-full md:w-1/2 text-lightgray px-4 mb-5">
        ...
        <label for="gajibulanan" class="block">
          ...
          <input type="text" id="gajibulanan" class="border-2 w-full px-2 py-1 mb-3 outline-none" onkeydown="return countOnly(event)" value="" placeholder="Rp. 0" required>
        </label>
      ...
      <div class="w-full md:w-1/2 px-4 text-lightgray">
        ...
        <label for="gajibulanan" class="block">
          ...
          <input type="text" name="nilai-zakat" id="nilaizakat" class="border-2 w-full px-2 py-1 mb-3 outline-none" readonly placeholder="Rp. 0">
        </label>
        <button class="btn btn-lightgreen" name="hitung-zakat">Salurkan Zakat</button>
      </div>
    </form>
