    ...
    <div class="col-md-6">
        ...
        <form action="<?= BASEURL ?>/profile/aksi_ubah_profil_amil" method="post">
            <div class="mb-3">
                ...
                <input type="text" name="nama" id="nama-lengkap" class="form-control" value="<?= $data['dataProfile']['nama'] ?>">
            </div>
            <div class="mb-3">
                <label for="username" class="form-label">Username</label>
                <input type="text" name="username" id="username" class="form-control" value="<?= $data['dataProfile']['username'] ?>">
            </div>
            <div class="mb-3">
