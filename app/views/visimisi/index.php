<div class="container">
  <div class="content">
    <div class="title mb-20">
      <h3 class="text-title">Visi Misi</h3>
      <span class="text-sm text-lightgray mt-2 inline-block">Visi Misi dari aplikasi zakat</span>
    </div>

    <!-- content visimisi -->
    <div>
      <?php echo $data['visimisi']['content']?>
    </div>
    ...
    <div class="text-center mt-20">
      <div class="inline-flex text-lightgray items-center mr-5">
        ...
        <span>Dibuat oleh: <strong><?= $data['visimisi']['username'] ?></strong></span>
      </div>
      ...
      <div class="inline-flex items-center text-lightgray">
        ...
        <span>Dibuat pada: <strong><?= date('d F Y',strtotime(explode(' ', $data['visimisi']['datetime'])[0])) ?></strong></span>
      </div>
    </div>
