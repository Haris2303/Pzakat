              ...
              <ul class="block lg:flex gap-7 items-center">
                ...
                <li class="lg:block hidden">
                  ...
                  <div class="w-full flex items-center gap-2 relative">
                    <input type="text" name="keyword" placeholder="Search tag.." id="keyword-lg" class="px-2 py-1 outline-none border-2 border-green text-sm rounded-full text-lightgray" autofocus>
