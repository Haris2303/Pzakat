<div class="container">
    <div class="content">
        <!-- program donasi -->
        <?php if (count($data['program']) > 0) : ?>
            <section id="program-donasi">
                <div class="title">
                    <h3 class="text-title">Program</h3>
                ...
                <a href="<?= BASEURL ?>/programs">
                    <div class="w-40 m-auto">
                        <button class="mt-10 btn btn-lightgreen">Lihat Semua Program</button>
                    </div>
                </a>
        ...
        <?php if (count($data['berita']) > 0) : ?>
            ...
            <a href="<?= BASEURL ?>/page/news">
                <div class="w-40 m-auto">
                    <button class="mt-10 btn btn-lightgreen">Lihat Semua Berita</button>
                </div>
            </a>
        <?php endif ?>
        <!-- end content berita -->
        ...
        <?php if (count($data['artikel']) > 0) : ?>
            ...
            <div class="flex">
                <div class="w-full flex flex-col gap-y-5 flex-wrap lg:flex-row text-sm">
                    <?php foreach ($data['artikel'] as $item) : ?>
            ...
            <a href="<?= BASEURL ?>/page/artikel">
                <div class="w-40 m-auto">
                    <button class="mt-10 btn btn-lightgreen">Lihat Semua Artikel</button>
                </div>
            </a>
        <?php endif ?>
        <!-- end content artikel -->
