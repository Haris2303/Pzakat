...
var datas = []; // Variabel yang ingin diakses

function fetchData() {
  const date = new Date()
  return new Promise(function(resolve, reject) {
    $.ajax({
      url: 'http://localhost/Pzakat/public/dashboard/getDataPemasukkanBulanan',
      dataType: 'json',
...
// Mengakses variabel setelah permintaan Ajax selesai
fetchData()
  .then(function() {
    dataLineChart(datas) // masukkan datas dari data ajax
  })
